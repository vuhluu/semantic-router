...
| Proposal | Created | Status | Scope |
| --- | --- | --- | --- |
| [Unified Model Catalog and Evaluation Index](./unified-model-catalog-and-evaluation-index) | 2026-09-04 | Implemented | Unifies provider, protocol, model, reasoning, presentation, Day-0, and evidence-backed ranking metadata. |
